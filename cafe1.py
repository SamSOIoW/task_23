...
stock = {'risotto': 25,'chicken alfredo': 8, #
         'antipasti': 15, 'lasagne': 34, 'garlic bread': 18, 'pizza': 28} 
# creation of second dictionary to show prices, linked to menu list
price = {'risotto': 14.50, 'chicken alfredo': 16.50, 'antipasti': 22.00,
         'lasagne': 12.28, 'garlic bread': 4.25, 'pizza': 11.00}
